...
export const ENEMY_DEFS: Record<string, EnemyDef> = {
  punk: { id: 'punk', name: 'Punk', hp: 46, speed: 2.1, weight: 1, heavyChance: 0.25, specialChance: 0, cooldown: [46, 95], frames: 6,
    attack: { startup: 9, active: 3, recovery: 14, range: 58, hit: { dx: 34, dy: 0, w: 44, h: 90, dmg: 3, hitstun: 12, kb: 2 } },
    heavy: { startup: 16, active: 4, recovery: 22, range: 62, hit: { dx: 38, dy: 0, w: 48, h: 90, dmg: 5, hitstun: 20, kb: 5, knockdown: true } } },
  chainer: { id: 'chainer', name: 'Chainer', hp: 58, speed: 1.8, weight: 1.2, heavyChance: 0.3, specialChance: 0.15, cooldown: [65, 120], frames: 6,
    attack: { startup: 18, active: 4, recovery: 18, range: 130, telegraph: true, hit: { dx: 70, dy: 0, w: 120, h: 80, dmg: 4, hitstun: 14, kb: 3 } },
    heavy: { startup: 22, active: 6, recovery: 24, range: 90, telegraph: true, hit: { dx: 0, dy: 0, w: 0, h: 100, dmg: 6, hitstun: 22, kb: 5, knockdown: true, radius: 80 } },
    special: { startup: 20, active: 10, recovery: 24, range: 140, telegraph: true, hit: { dx: 0, dy: 0, w: 0, h: 100, dmg: 9, hitstun: 24, kb: 6, knockdown: true, radius: 110 } } },
  brawler: { id: 'brawler', name: 'Brawler', hp: 92, speed: 1.4, weight: 1.6, heavyChance: 0.45, specialChance: 0, cooldown: [58, 110], frames: 6,
    attack: { startup: 12, active: 4, recovery: 18, range: 62, hit: { dx: 36, dy: 0, w: 50, h: 90, dmg: 4, hitstun: 15, kb: 3 } },
    heavy: { startup: 24, active: 5, recovery: 26, range: 70, telegraph: true, armor: true, hit: { dx: 40, dy: 0, w: 56, h: 110, dmg: 8, hitstun: 26, kb: 4, launch: 7 } } },
  kicker: { id: 'kicker', name: 'Kicker', hp: 56, speed: 2.6, weight: 1.2, heavyChance: 0.3, specialChance: 0.3, cooldown: [40, 85], frames: 6, evasive: true,
    attack: { startup: 8, active: 3, recovery: 12, range: 60, hit: { dx: 36, dy: 0, w: 46, h: 90, dmg: 3, hitstun: 12, kb: 2 } },
    heavy: { startup: 14, active: 4, recovery: 18, range: 78, hit: { dx: 44, dy: 0, w: 60, h: 100, dmg: 5, hitstun: 20, kb: 5, knockdown: true } },
    special: { startup: 12, active: 12, recovery: 16, range: 220, telegraph: true, speed: 7, hit: { dx: 30, dy: 0, w: 60, h: 90, dmg: 6, hitstun: 20, kb: 6, knockdown: true } } },
  knight: { id: 'knight', name: 'Knight', hp: 82, speed: 1.6, weight: 1.5, heavyChance: 0.35, specialChance: 0.1, cooldown: [58, 110], frames: 6, guard: true,
    attack: { startup: 12, active: 4, recovery: 18, range: 76, hit: { dx: 44, dy: 0, w: 60, h: 100, dmg: 5, hitstun: 15, kb: 3 } },
    heavy: { startup: 20, active: 5, recovery: 24, range: 84, telegraph: true, hit: { dx: 46, dy: 0, w: 70, h: 110, dmg: 7, hitstun: 24, kb: 5, knockdown: true } },
    special: { startup: 18, active: 6, recovery: 22, range: 110, telegraph: true, hit: { dx: 60, dy: 0, w: 110, h: 100, dmg: 9, hitstun: 24, kb: 6, knockdown: true } } },
  shield: { id: 'shield', name: 'Shield Trooper', hp: 132, speed: 1.5, weight: 2.2, heavyChance: 0.4, specialChance: 0.3, cooldown: [72, 130], frames: 6, guard: true,
    attack: { startup: 12, active: 4, recovery: 18, range: 60, hit: { dx: 36, dy: 0, w: 48, h: 100, dmg: 4, hitstun: 15, kb: 3 } },
    heavy: { startup: 20, active: 5, recovery: 24, range: 66, telegraph: true, armor: true, hit: { dx: 38, dy: 0, w: 56, h: 110, dmg: 6, hitstun: 24, kb: 6, knockdown: true } },
    special: { startup: 24, active: 30, recovery: 24, range: 380, telegraph: true, speed: 8, armor: true, hit: { dx: 30, dy: 0, w: 60, h: 100, dmg: 10, hitstun: 24, kb: 7, knockdown: true } } },
};
