...
const STR = {
  ...
  solo: ['SOLO', 'לבד'],
  tapFace: ['tap a face to pick', 'הקישו על פנים לבחירה'],
  statHp: ['HEALTH', 'חיים'], statSpeed: ['SPEED', 'מהירות'], statPower: ['POWER', 'כוח'],
  offHint: ['you fight alone', 'נלחמים לבד'],
  assistHint: ['comes when you call (CALL button / H), hits, and leaves', 'מגיע כשקוראים לו (כפתור קריאה / H), מכה, והולך'],
  sidekickHint: ['fights beside you the whole level', 'נלחם לצידכם לאורך כל השלב'],
