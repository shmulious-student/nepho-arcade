...
| `defeat.png` | **defeat** — 1 upright, struck, 2 clutches the gut, 3 drops to a knee, 4–6 topples, 7 lands, **8–9 flat on the ground, identical, staying down** (face down, arms spread). The lying figure is the same size as the standing one — full length across the cell, never shrunk. |
