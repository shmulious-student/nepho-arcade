...
Standing on 2026-09-13 (`npm run readiness`): 13 ready, 1 failed (nepho), 15 legacy, plus one gate
failure on an fx set (pitz `run`). Shmuel's `walk` and `dash` were redelivered 2026-09-13 and are done.
...
| 2 | [glass-warden](glass-warden.md) | boss | 7 | Step A sheet + 6 action files |
| 3 | [kilnheart](kilnheart.md) | boss | 7 | Step A sheet + 6 action files |
| 4 | [monk-zero](monk-zero.md) | boss | 7 | Step A sheet + 6 action files |
| 5 | [market-king](market-king.md) | boss | 7 | Step A sheet + 6 action files |
| 6 | [railmaw](railmaw.md) | boss | 7 | Step A sheet + 6 action files |
| 7 | [crown-runner](crown-runner.md) | boss | 7 | Step A sheet + 6 action files |
| 8 | [the-null](the-null.md) | boss | 7 | Step A sheet + 6 action files |
| 9 | [vault-mother](vault-mother.md) | boss | 7 | Step A sheet + 6 action files |
| 10 | [ultra-signal](ultra-signal.md) | boss | 7 | Step A sheet + 6 action files |
| 11 | [brawler](brawler.md) | enemy | 11 | Step A sheet + 10 action files |
| 12 | [knight](knight.md) | enemy | 11 | Step A sheet + 10 action files |
| 13 | [chainer](chainer.md) | enemy | 11 | Step A sheet + 10 action files |
| 14 | [kicker](kicker.md) | enemy | 11 | Step A sheet + 10 action files |
| 15 | [shield](shield.md) | enemy | 11 | Step A sheet + 10 action files |
| 16 | [nepho](nepho.md) | hero | 14 | Step A sheet + 12 action files + hero card (the set is redone whole) |
| 17 | [byte](byte.md) | hero | 14 | Step A sheet + 12 action files + hero card |

**Total: 147 image requests** on a clean run (1 fix · 63 for the nine bosses · 55 for the five
